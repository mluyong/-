<template>
     <div class="Car-pr">
        <el-form :model="IntegralForm" :rules="rules" ref="IntegralForm" label-width="150px" class="demo-IntegralForm Car-pr-conter">
            <el-form-item label="">
              <h2 align="center">车险发布</h2>
            </el-form-item>
            
            <el-form-item label="车险名称：" prop="name">
                <el-input v-model="IntegralForm.name"></el-input>
            </el-form-item>
            <el-form-item label="车险简介：" prop="synopsis">
                <el-input v-model="IntegralForm.synopsis"></el-input>
            </el-form-item>
...
export default {
  data() {
    return {
      ...
      rules: {
        name: [
          { required: true, message: "请输入车险名称" },
          { min: 3, max: 20, message: "长度在 3 到 20 个字符" }
        ],
        synopsis: [
          { required: true, message: "请输入车险简介" }
        ]
      }
    };
  },
